...
class HttpClientResponse {
  ...
  bool get statusCodeIsBadRequest => statusCode >= 400 && statusCode < 500;
  bool get statusCodeIsServerError => statusCode == 500;
  bool get statusCodeIsServerTimeout => statusCode == 504;
